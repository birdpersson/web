			...
			<div id='slidebar'>
					...
					<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner" role="listbox">
							...
							<div class="carousel-item active"
								:style="{'background-image': 'url(' + this.apartment.images[0] + ')'}">
								<!-- <div class="carousel-caption d-none d-md-block">
                </div> -->
							</div>
							<!-- Slide Two - Set the background image for this slide in the line below -->
							<div class="carousel-item" v-for="img in getOtherImgs"
						...
						<a v-if='isOtherImgs' class="carousel-control-prev" href="#carouselExampleIndicators"
							role="button" data-slide="prev">
							<span class="carousel-control-prev-icon" aria-hidden="true"></span>
							<span class="sr-only">Previous</span>
						</a>
						<a v-if='isOtherImgs' class="carousel-control-next" href="#carouselExampleIndicators"
				...
				<div class="card-body">
					...
					<h3 class="card-title">Location:
						<span style="font-size: 25px;">longitude: {{apartment.location.longitude}} - latitude:
