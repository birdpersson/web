...
<div id="apartments-overview">
    ...
    <table border="1px;">
        ...
        <tbody>
            <tr>
                ...
                <td>atribut2</td>
                <td>
                    <router-link to="/apartmentComments"><button> Komentari </button></router-link>
                </td>
                <td>
                    <router-link to="/newReservation"><button> Rezervacija </button></router-link>
                </td>
            </tr>
            <tr>
                <td>atribut3</td>
    ...
    <div id='options'>
        ...
        <router-link to="/amenitiesOverview"> <button v-if='isAdmin' style='padding-left: 5px;'>Sadrzaj
                apartmana</button> </router-link>
    </div>
