...
<div id="apartments-overview">
            ...
            <form class="form-inline">
                ...
                <div>
                    ...
                    <div style='display:inline;' v-show='isFilter'>
                        <select v-if='isActive()' style="padding:7px; margin-right: 10px" id='listOfTypes'
                            v-model="filterQueryType">
                            <option disabled value="">Types</option>
                            <option v-for='type in types'>{{type}}</option>
                        </select>
                        <select v-if='!isGuest' style="padding:7px; margin-right: 10px" id='listOfStatuses'
                            v-model="filterQueryStatus">
                            <option disabled value="">Status</option>
                            <option v-for='status in statuses'>{{status}}</option>
                        </select>
                        <select v-if='isActive()' style="padding:7px; margin-right: 10px" id='typeOfAmenities'
                            v-model="choosenType">
                        ...
                        <select v-if='isActive()' style="padding:7px; margin-right: 10px" id='listOfAmenities'
                            v-model="filterQueryAmanity">
    ...
    <div class="container" id='main'>
        <table class="table">
            ...
            <tbody>
                <tr v-bind:key='apartments.id' v-for="apartment in filteredApartments">
                    ...
                    <td>{{apartment.location.address.street}} - {{apartment.location.address.postalCode}}
                        {{apartment.location.address.city}} </td>
        ...
        <div id='options'>
            ...
            <router-link to="/apartmentNew"> <button class='btn-lg classButton' v-if='isHost'>+ Add
                    apartment</span></button></router-link>
            <router-link to="/apartmentComments"> <button class='classButton' v-if='!isGuest'>Comments</button>
            </router-link>
            <router-link to="/reservations"> <button class='classButton' v-if='!isGuest'>Reservations</button>
            </router-link>
